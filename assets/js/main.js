...
Template Name: Rockstar Template
Author: www.godexdesign.com
Version: 1.0
Design and Developed by: Godex Design
...
(function ($) {
    ...
    jQuery(document).ready(function($){
      ...
      resizeBackground();
        ...
        $(function() {
            element.typed({
                strings: ["Professional Server.", "Friendly community.", "Daily events."],
                typeSpeed: 100,
                loop: true,
            });
        });
